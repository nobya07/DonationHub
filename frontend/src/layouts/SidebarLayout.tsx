    ...
    <div className="min-h-screen bg-gray-50 md:flex">
      <aside className="sticky top-0 hidden h-screen w-64 shrink-0 flex-col border-r border-gray-200 bg-white md:flex">
        <div className="flex items-center gap-3 border-b border-gray-200 px-5 py-4">
          ...
          <div>
            <p className="text-lg font-semibold leading-tight text-gray-900">DonationHub</p>
        ...
        <div className="border-t border-gray-200 px-5 py-4">
          ...
          <p className="mb-3 truncate text-xs text-gray-500">@{user?.username}</p>
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <header className="sticky top-0 z-10 border-b border-gray-200 bg-white/80 backdrop-blur-md md:hidden">
          <div className="flex h-14 items-center justify-between px-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-semibold text-gray-900">DonationHub</span>
            </div>
